...
public class Data {
	...
	public Data(){
		...
		file = new LFile(new File(dir.getAbsolutePath() + "//data.txt"));
	}
	...
	void makeFile(){
		...
		file.append("##in this file is the data from the plugin RollercoasterManager stored.");
		file.append("##Do not edit this file!");
		file.append("##it will mess up the plugin");
	}
